...
class Wp_Cbf_Public {
	...
	public function __construct( $plugin_name, $version ) {
        ...
        $this->display_plugin_front_part();
	}

	/**
     * Render form on front-end
     *
	*/
    public function display_plugin_front_part() {
        include_once( 'partials/wp-cbf-public-display.php' );
    }
