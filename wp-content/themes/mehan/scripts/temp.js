...
!function () {
    window.wp = window.wp || {}, wp.sanitize = {
        stripTags: function (a) {
            ...
            var b = wp.sanitize.stripTags(a), c = document.createElement("textarea");
            try {
...
jQuery(document).ready(function ($) {
    ...
    if (premmerceSearch.forceProductSearch) {
        search.each(function () {
            ...
            $(document).on('submit', searchForm, function () {
                var el = $('<input/>', {'type': 'hidden', 'name': 'post_type', 'value': 'product'});
    ...
    search.each(function () {
        ...
        search.autocomplete({
            ...
            }, delay: 500, minLength: parseInt(premmerceSearch.minLength), open: function () {
...
(function ($) {
    $(document).on('click', '[data-oneclick-order--btn]', function (e) {
        ...
        $.magnificPopup.close();
        $.magnificPopup.open({
            items: {src: modalUrl + '&product_id=' + productId},
            type: 'ajax',
            showCloseBtn: !1,
            modal: !1
        })
    ...
    $(document).on("show_variation", function (event, variation) {
        var isDisabled = variation === undefined || (variation.is_purchasable === !1 || variation.is_in_stock === !1);
        toggleOneClickOrderButton(isDisabled, $(event.target))
    });
    $(document).on("woocommerce_variation_select_change", function (event) {
        toggleOneClickOrderButton(!0, $(event.target))
    });
...
(function ($) {
    ...
    $.mlsModal = function (options) {
        $.magnificPopup.close();
        $.magnificPopup.open({
            items: {src: options.src},
            type: 'ajax',
            ajax: {settings: {data: options.data}},
            callbacks: {
    ...
    $(document).on('click', '[data-modal-wishlist]', function (e) {
        ...
        modalUrl = modalUrl ? modalUrl : $this.attr('href');
        $.magnificPopup.close();
        $.magnificPopup.open({items: {src: modalUrl}, type: 'ajax', showCloseBtn: !1, modal: !1})
    });
    ...
    $(document).on('change', 'input[type=radio]', function (e) {
        ...
        if (e.target.hasAttribute('data-wishlist-new-radio')) {
            newWishListName.attr('required', !0)
        } else {
            newWishListName.attr('required', !1)
        }
    });
...
(function ($) {
    $(document).on('click', '[data-pc-add-to-compare-btn="add"]', function (e) {
        ...
        $.ajax({
            url: params.url, type: 'post', data: params, beforeSend: function () {
...
window.onload = () => {
    let phoneInput = IMask(document.getElementById('customInputPhone'), {
    ...
    document.querySelector('.custom-module-btn').addEventListener('click', function (e) {
        ...
        for (const [key, value] of formData.entries()) {
            ...
            } else if (key === 'vitaminsUserPhone' && value.match(/\d+/g).map(function (item) {
                return item
            }).join('').length !== 12) {
                form.elements[key].classList.add('custom_form_alert');
        ...
        if (errors.length === 0) {
            try {
                ...
                jQuery.post({
                    type: 'POST', url: sendEmailAjax.url, data: data, beforeSend: () => {
    ...
    document.addEventListener('click', function (e) {
        ...
        if (e.target.classList.contains('products-list__item-link')) {
            ...
            if (node.length > 1) {
                ...
                let listToAppend = e.target.parentNode.children.item(1).cloneNode(!0);
...
WebFontConfig = {google: {families: ["Roboto:regular,700",]}};
(function () {
...
if (!window.msweb) {
    msweb = {
        plugins: {
            ajaxUrl: "http://vitamins.com.ua/wp-admin/admin-ajax.php",
            msreviews: {_cssPrefix: 'msweb_ms-reviews-', _url: "http://vitamins.com.ua/wp-content/plugins/ms-reviews"}
        }
    }
} else {
    msweb.plugins.msreviews = {
        _cssPrefix: 'msweb_ms-reviews-',
        _url: "http://vitamins.com.ua/wp-content/plugins/ms-reviews"
    }
}
;(function ($) {
    $(document).ready(function () {
        var csp = msweb.plugins.msreviews._cssPrefix;
        msweb.plugins.msreviews.showNickname = !0;
        msweb.plugins.msreviews.showAvatar = !0;
        ...
        $('[name="shownickname"]').change(function (oEvent) {
            if ($(this).is(':checked')) {
                ...
                msweb.plugins.msreviews.showNickname = !1
            }
        });
        $('[name="showuseravatar"]').change(function (oEvent) {
            if ($(this).is(':checked')) {
                ...
                msweb.plugins.msreviews.showAvatar = !1
            }
        });
        ...
        $('.' + csp + 'sendreview').click(function () {
            ...
            msweb.plugins.msreviews.showLoader(!0, $('.' + csp + 'reviews'));
            $.post(msweb.plugins.ajaxUrl, {
                ...
                try {
                    ...
                    if (d.status == 200) {
                        ...
                        $(newReview).html('<div class="' + csp + 'r-rate ' + csp + 'rate-' + msweb.plugins.msreviews.rate + '"></div>' + '             <div class="' + csp + 'r-user-nickName">' + nick + '</div>' + '             <div class="' + csp + 'r-userAvatar"><img src="' + imgSrc + '"></div>' + '             <div class="' + csp + 'r-userReview">' + review + '</div>');
        ...
        $('.msweb-reviews-delete-review').click(function (e) {
            ...
            if (confirm('Удалить этот отзыв?')) {
                msweb.plugins.msreviews.showLoader(!0);
                $.post(msweb.plugins.ajaxUrl, {
                    action: 'msweb_MSReviews_ajax',
                    data: {rid: rid},
                    act: 'deleteReview'
                    ...
                    try {
                        ...
                        if (d.status == 200) {
                            reviewBlock.fadeOut()
                        } else throw new Error(d.message + ' ' + d.status)
                    } catch (e) {
                        alert(e.message)
                    }
                    msweb.plugins.msreviews.hideLoader()
...
})(jQuery);/*! Magnific Popup - v1.0.1 - 2015-12-30
...
jQuery(document).ready(function ($) {
    $(document).on('submit', '[data-price-spy-form]', function (event) {
        ...
        data.push({'name': 'action', 'value': 'add_price_spy'});
        if (isVariable) {
            var variationId = $("[name='variation_id']").val();
            data.push({'name': 'variation_id', 'value': variationId})
        }
        $.ajax({
            url: PriceSpyData.ajaxUrl, type: 'post', data: data, beforeSend: function () {
                form.block({message: null, overlayCSS: {background: '#fff', opacity: 0.6}})
            }, success: function (response) {
                response = JSON.parse(response);
                form.unblock();
    ...
    $('[data-price-spy-table-remove]').click(function () {
        ...
        $.ajax({
            ...
            type: 'post',
            data: {action: 'delete_price_spy', product_id: productId,},
            success: function (response) {
                response = JSON.parse(response);
                if (response.success) {
                    row.hide(500)
    ...
    $(document).on('click', '[data-open-popup-spy-form]', function (e) {
        ...
        $.magnificPopup.close();
        $.magnificPopup.open({items: {src: popup, type: 'inline'}, showCloseBtn: !1})
    });
    $('[data-price-spy-close]').click(function () {
        $.magnificPopup.close()
    });
    $(document).on("show_variation", function (event, variation) {
        var hideButton = variation === undefined || (variation.is_purchasable === !1 || variation.is_in_stock === !1);
        toggleButton(!hideButton, $(event.target))
    });
    $(document).on("woocommerce_variation_select_change", function (event) {
        toggleButton(!1, $(event.target))
    });
    $(document).on('reset_data', function (event) {
        toggleButton(!1, $(event.target))
    });
...
jQuery(document).ready(function ($) {
    function PremmerceProductWaitSubscribe() {
        ...
        $(document).on('click', this.selector.devareButtons, function (event) {
            ...
            this.unsubscribe({
                hash: hash, beforeSend: function () {
                    td.block({message: null, overlayCSS: {background: '#fff', opacity: 0.6}})
                }, success: function (response) {
                    td.unblock();
                    if (response.result) {
                        location.reload()
        ...
        $(document).on('click', this.selector.popupLink, function (event) {
            event.preventDefault();
            $.magnificPopup.close();
            $.magnificPopup.open({items: {src: $(this).attr('href')}, type: 'ajax', showCloseBtn: !1, modal: !1})
        })
    }
...
jQuery(function (e) {
    ...
    t.prototype.onAddToCart = function (t) {
        ...
        var a = e(this), r = a.closest(".woocommerce-mini-cart-item");
...
(function ($, window, document, undefined) {
    ...
    $.fn.lazyload = function (options) {
        ...
        this.each(function () {
            ...
            var $self = $(self);
            self.loaded = !1;
            if ($self.attr("src") === undefined || $self.attr("src") === !1) {
                if ($self.is("img")) {
...
!function (t) {
    ...
    t.mlsAjax = {
        preloaderShow: function (t) {
            ...
            a = a || t("html"), t(e).find("[data-ajax-grab]").each(function () {
                var e = t(this), n = e.data("ajax-grab"), i = e.html();
    ...
    if ("undefined" != typeof saleszoneLocalize) {
        ...
        t.extend(!0, t.magnificPopup.defaults, {
            tClose: e.tClose,
            tLoading: e.tLoading,
            gallery: {tPrev: e.tPrevious, tNext: e.tNext, tCounter: e.tOf}
        })
    }
}(jQuery), function (t) {
    t.mlsMedia = {
        zoomImage: function () {
            ...
            e.trigger("zoom.destroy"), e.each(function () {
                var a = t(this), n = a.attr("data-zoom-image-url"), i = a.siblings("[data-zoom-wrapper]");
                a.zoom({
                    url: n, target: i, touch: !1, onZoomIn: function () {
            ...
            e = e || 0, a = a || t("[data-magnific-galley]"), a.each(function () {
                var a, n, i = t(this), o = i.find("[data-magnific-galley-main]"),
                    r = i.find("[data-magnific-galley-thumb]"), d = [];
                r.length > 0 && (r.each(function () {
                    var e = {src: t(this).attr("href")};
                    d.push(e)
...
var mlsMegamenu = function (t) {
    var e = function (t, e) {
        ...
        var e = document.querySelector(t.scope), a = e.querySelectorAll(t.items), n = e.offsetWidth,
        ...
        Array.prototype.forEach.call(e, function (t) {
            var e = t.querySelector("[data-megamenu-wrap]"), o = t.querySelector("[data-megamenu-coll]"),
                r = t.querySelectorAll("[data-megamenu-coll-item]"), d = a(r);
            if (!(d <= 1)) {
                var s = n(o, d);
        ...
        if (t.wrap && t.container && t.indent) {
            var e = t.container.getBoundingClientRect(), a = t.wrap.getBoundingClientRect(), n = a.left - e.left,
                i = t.container.offsetWidth, o = t.wrap.offsetWidth, r = i - n;
...
!function (t) {
    t.mlsModal = function (e) {
        ...
        t.magnificPopup.close(), t.magnificPopup.open({
            items: {src: e, type: "inline"}, callbacks: {
                open: function () {
                    t(document).trigger("cart_modal_open")
                }
            }, showCloseBtn: !1, modal: !1
        })
    }, t.mlsModalInline = function (e) {
        t.magnificPopup.close(), t.magnificPopup.open({items: {src: e, type: "inline"}, showCloseBtn: !1, modal: !1})
    ...
    var o = "showHidePart", r = {propertyName: "value", isOpen: !1, speed: 500, hiddenClass: "hidden"};
    t.extend(i.prototype, {
        init: function () {
            var e = this, a = t(e.element);
            ...
            var e = this;
            e.setting.innerHeight = e.setting.container.find("[data-inner-wrap]").height(), e.setting.container.css("height", this.setting.maxHeight), e.setting.container.css("max-height", "none"), e.setting.container.animate({height: e.setting.innerHeight}, e.setting.speed, function () {
                t(e.element).html(e.setting.hideText), e.setting.container.css("height", "auto")
            }), e.setting.isOpen = !0
        }, close: function () {
            var e = this;
            e.setting.container.animate({height: e.setting.maxHeight}, e.setting.speed, function () {
    ...
    t.mlsSlider = {
        getCols: function (e) {
            var a = [768, 992, 1200], n = !!e && e.split(",");
            return !!t.isArray(n) && (n.shift(), n.length > 0 && t.map(n, function (t, e) {
                return {breakpoint: a[e], settings: {slidesToShow: parseInt(t)}}
            }))
            ...
            e.each(function () {
                var e = t(this), a = t("[data-slider-slides]", e).attr("data-slider-slides"),
        ...
        countdown: {
            init: function (e) {
                for (var a = document.querySelectorAll(e.scope), n = function (e, a, n) {
                    ...
                    var t = a[i].getAttribute(e.expireDateAttribute), o = a[i].querySelectorAll(e.item),
                        r = setInterval(function () {
                            n(t, o, r)
                        }, 1e3)
                }()
            }, getTimeLeft: function (t) {
                var e = Date.parse(t) - Date.parse(new Date), a = Math.floor(e / 1e3 % 60),
                    n = Math.floor(e / 1e3 / 60 % 60), i = Math.floor(e / 36e5 % 24), o = Math.floor(e / 864e5);
    ...
    var e = t("[form]").get(0), a = !window.ActiveXObject && "ActiveXObject" in window;
    e && window.HTMLFormElement && e.form instanceof HTMLFormElement && !a || (t.fn.appendField = function (e) {
        ...
        var a = t(this), n = t("[form=" + a.attr("id") + "]").serializeArray();
        a.appendField(n)
    }).each(function () {
        var e = this, a = t(e), n = t("[form=" + a.attr("id") + "]");
        n.filter("button, input").filter("[type=reset],[type=submit]").click(function () {
            ...
            })) : a.match(/^submit|image$/i) && t(e).appendField({name: this.name, value: this.value}).submit()
        })
    }))
}(jQuery), function () {
    svg4everybody()
    ...
    function a() {
        var e = window.location.hash, a = "#tab=";
        if (e.indexOf(a) === -1) {
    ...
    function n(e) {
        t("html, body").animate({scrollTop: e.offset().top}, 800)
    }
    ...
    }, c = 768, l = t(s.scope), u = t(window).width();
    l.each(function () {
        var e = t(this), a = e.find(s.item).first();
        ...
        e.preventDefault();
        var a = t(e.delegateTarget), n = t(this), i = n.closest(s.item), d = n.attr("href").replace("#", "");
    ...
    t(document.body).on("wc_fragments_refreshed", function () {
        ...
        if ("undefined" == typeof woocs_loading_first_time) t.mlsCartModalInline(a["[data-cart-modal-fragment]"]); else {
            var o = function () {
        ...
        e.preventDefault(), t.magnificPopup.open({
            items: {src: wc_cart_fragments_params.wc_ajax_url.toString().replace("%%endpoint%%", "get_refreshed_fragments")},
            type: "ajax",
            callbacks: {
        ...
        t.mlsAjax.preloaderShow({type: "frame", frame: t("[data-cart-summary]")})
        ...
        var i = a.closest("[data-loop-add-to-cart-form]"), o = t(document.getElementById(a.attr("form"))),
            r = i.length > 0 ? i : o;
        ...
        e.preventDefault();
        var a = t(this), n = a.closest(".woocommerce-cart-form"), i = a.closest('[data-cart-summary="modal"]');
        ...
        var a = t(this), n = a.closest(".woocommerce-cart-form"), i = a.attr("max") ? a.attr("max") : 1 / 0,
            o = a.val();
        o > i && a.val(i);
        var r = n.serialize();
        t.ajax({
            url: n.attr("action"), type: "post", data: r, beforeSend: function () {
                t.mlsAjax.preloaderShow({type: "frame", frame: t("[data-cart-summary]")})
            }, success: function () {
        ...
        e.preventDefault(), t.mlsAjax.preloaderShow({type: "frame", frame: t("[data-cart-frame-fragment]")})
        ...
        t("[data-checkout-shipping-fragments]").block({message: null, overlayCSS: {background: "#fff", opacity: .6}})
    })
}(jQuery), function (t) {
    ...
    var n = 991, i = document.querySelector("[data-catalog-btn]"),
        o = document.querySelector("[data-catalog-btn-overlay]"), r = document.querySelector("[data-catalog-btn-menu]"),
        d = "is-hidden";
    if (r) {
    ...
    t(document).on("submit", "[data-comments-form]", function (e) {
        e.preventDefault();
        var a = t(this), n = a.closest("[data-comments]"), i = a.attr("data-comments-form"),
            o = '[data-comments-form="' + i + '"]', r = o + " [data-comments-success]",
            d = o + " [data-comments-error-frame]", s = o + " [data-comments-error-list]";
        t.ajax({
        ...
        e.preventDefault();
        var a = t(this), n = a.attr("data-comments-reply-link"), i = a.closest("[data-comments-post]"),
            o = i.find("[data-comments-reply-form-placeholder]").first(), r = a.attr("data-comments-reply-parent-id"),
            d = o.find("[data-comments-reply-form]").length;
        d ? o.toggleClass("hidden") : t.ajax({
            url: n, type: "get", beforeSend: function () {
        ...
        e.preventDefault();
        var a = t(this), n = a.attr("data-comments-vote-url"),
            i = a.closest("[data-comments-post]").attr("data-comments-post"), o = a.find("[data-comments-vote-value]");
        t.ajax({
            url: n, type: "post", data: {comid: i}, dataType: "json", success: function (t) {
    ...
    t(document).on("click", '[data-add-to-compare-btn="add"]', function (e) {
        e.preventDefault();
        var a = t(this), n = a.closest("[data-add-to-compare]"),
            i = JSON.parse(n.find("[data-add-to-compare-data]").attr("data-add-to-compare-data"));
        t.ajax({
            url: i.url, type: "post", data: i, beforeSend: function () {
                "link" === a.attr("data-add-to-compare-btn-type") && t.mlsAjax.preloaderShow({type: "text", frame: a})
            }, success: function () {
    ...
    t(document).on("submit", "[data-form-ajax]", function (e) {
        e.preventDefault();
        var a = t(this), n = t('[data-form-ajax="' + a.attr("data-form-ajax") + '"]');
        t.ajax({
            url: a.attr("action"),
            type: a.attr("method") ? a.attr("method") : "get",
            data: a.serialize(),
            beforeSend: function () {
                t.mlsAjax.preloaderShow({type: "frame", frame: a})
            },
            success: function (e) {
    ...
    t(document).on("click", "[data-modal]", function (e) {
        ...
        n = n ? n : a.attr("href"), t.mlsModal({src: n})
    ...
    t("[data-nav-hover-item]").on("mouseenter", function () {
        ...
        if (a > e) for (var r = 0; r < t.length; r++) t[r].setAttribute("data-nav-direction", "rtl")
    });
    ...
    t(document).on("reset_data", ".variations_form", function () {
        var e = t(this).closest("[data-product]"), a = e.find("[data-product-photo-scope]"),
            n = a.find("[data-product-photo]"), i = n.attr("src"), o = n.attr("data-product-photo-origin");
        if (i !== o) {
        ...
        var s = i.find("[data-product-photo-scope]"), c = s.find("[data-product-photo]").attr("src"),
    ...
    function a(e) {
        ...
        var a = t("[data-mobile-nav-list]:not(.hidden):not(.mobile-nav__list--is-moving)"), n = a.get(0).scrollHeight,
            r = a.height(), d = a.scrollTop(), s = n - r - d;
    ...
    var i, o, r = t("[ data-page-pushy-mobile]"), d = t("[ data-page-pushy-container]"),
        s = t("[data-page-pushy-overlay]"), c = t("html"), l = "page__mobile--js-open", u = "page__body--js-pushed",
    ...
    var e = {
        showSearch: function () {
            var e = t(this).closest("[data-search-overlay-scope]"), a = e.find("[data-search-overlay-overlay]"),
    ...
    var e = {scope: "[data-pc-tab-scope]", link: "[data-pc-tab-target]", content: "[data-pc-tab-content]"};
    t("[data-pc-tab-scope] [data-pc-tab-target]").removeClass("js-init-active"), t("[data-pc-tab-scope] [data-pc-tab-target]").first().addClass("is-active"), t(document).on("click", e.link, function (a) {
        a.preventDefault();
        var n = t(this), i = n.next(), o = n.closest(e.scope), r = t('[data-pc-tab-content="' + i + '"]', o);
    ...
    t(document).on("click", "[data-premmerce-wishlist-new-input]", function () {
        ...
        e.preventDefault();
        var a = t(this), n = t("[data-premmerce-wishlist-ajax]");
        t.ajax({
            url: a.attr("action"),
            type: a.attr("method") ? a.attr("method") : "get",
            data: a.serialize(),
        ...
        event.preventDefault();
        var e = t(this), a = e.attr("data-premmerce-wishlist-edit-modal--url");
        t.mlsModal({src: a})
    ...
    var e = t('[data-slider="mainpage-brands"]'), a = t("[data-slider-slides]", e).attr("data-slider-slides");
    t("[data-slider-slides]", e).find("[data-slider-slide]").css("float", "left").end().slick({
        dots: !1,
        arrows: !0,
        adaptiveHeight: !1,
    ...
    function e() {
        t('[data-slider="cross-sells"]').each(function () {
            var e = t(this), a = e.find("[data-slider-slides]"), n = a.attr("data-slider-slides");
    ...
    t(document).on("change", "[data-payments-radio--control]", function () {
        var e = t(this), a = t("#place_order"), n = e.attr("data-order_button_text");
    ...
    e.prototype.loadMorebtnClickHandler = function (e) {
        e.preventDefault();
        var n = t(e.target).closest(a.btn), i = t(a.next).attr("href");
        ...
        var a = this.pageStartNumber, n = this.currentPage;
        return e = t(e), e.find(".page-numbers").each(function () {
            var e = t(this), i = parseInt(e.text());
    ...
    t.extend(i.prototype, {
        init: function () {
            ...
            var e = t(this.input), a = e.data("quantity-step"),
                n = String(a).substring(String(a).indexOf(".")).length - 1;
            this.settings["float"] = 0 !== n
        }, changeQuantity: function (e) {
            e.preventDefault();
            var a, n = t(this.element), i = t(e.target), o = n.find("[data-quantity-field]"),
                r = Number(o.val().replace(",", ".")), d = t(i).attr("data-quantity-control"),
            ...
            e = e || event;
            var a, n = this.getChar(e), i = this.settings.validationMessage.onlyNumber,
                o = this.settings.decimalSeparatorReg, r = t(this.input).val();
            ...
            var a = t(this.input), n = a.val();
            return this.validateInput(n)
        }, validateInput: function (e) {
            var a, n = t(this.input), i = n.data("quantity-max") || 1 / 0, o = n.data("quantity-min") || -(1 / 0),
                r = this.settings.validationMessage.max, d = this.settings.validationMessage.min,
    ...
    function e(t) {
        var e = (screen.width - 570) / 2, a = (screen.height - 570) / 2, n = "570px", i = "570px",
    ...
    t.mlsTime.countdown.init({scope: "[data-sales-timer]", item: "[data-sales-timer-item]"})
}(jQuery), function (t) {
    t("[data-mobile-nav-link]", "[data-mobile-nav]").on("click", function (e) {
        e.preventDefault();
        var a = t(this), n = a.closest("[data-mobile-nav-item]").find(" > [data-mobile-nav-list]"),
        ...
        e.preventDefault();
        var a = t(this), n = a.closest("[data-mobile-nav-list]").parent().closest("[data-mobile-nav-list]"),
    ...
    t(document).on("click", "[data-product-photo-thumb]", function (n) {
        n.preventDefault();
        var i, o = t(this), r = o.closest("[data-product-photo-scope]"), d = "[data-product-photo-thumb]",
            s = "[data-product-photo-thumb-active]", c = o.closest("[data-magnific-galley]"), l = o.attr("href"),
            u = o.attr("data-product-photo-thumb"), m = r.find("[data-product-photo-link]"),
            f = r.find("[data-product-photo]"), h = r.find("[data-zoom-image]"),
    ...
    t(document).on("click", "[data-product-quick-view-button]", function (e) {
        e.preventDefault();
        var a = t(this), n = a.closest("[data-product]"), i = JSON.parse(a.attr("data-product-quick-view-button"));
        t.ajax({
    ...
    t(document).on("click", "[data-premmerce-change-currency]", function () {
        var e = t(this).attr("data-currency-id"), a = new URL(document.location.href);
    ...
    t(document).on("click", "[data-socauth-popup]", function (e) {
        e.preventDefault();
        var a = t(this), n = {href: a.attr("href"), title: a.attr("title"), width: 500, height: 600},
            i = window.innerWidth / 2 - n.width / 2, o = window.innerHeight / 2 - n.height / 2;
    ...
    t(document).on("click", "[data-sidebar-widget--button]", function () {
        var e = t(this).closest("[data-sidebar-widget--scope]"), a = e.find("[data-sidebar-widget--toggle]"),
    ...
    var e = t(".widget_price_filter"), a = e.find("form"), n = "#min_price", i = "#max_price",
        o = ".price_slider_wrapper .clear", r = parseFloat(e.find(n).attr("data-min")),
        d = parseFloat(e.find(i).attr("data-max")), s = parseFloat(e.find(n).val()), c = parseFloat(e.find(i).val());
    t(o).slider({
        min: r, max: d, values: [s, c], range: !0, slide: function (t, a) {
            var o = a.values[0], r = a.values[1];
...
jQuery(function ($) {
    $(document).on('click', '[data-package-add-to-cart]', function (e) {
        e.preventDefault();
        $.ajax({
            type: 'post', url: $(this).attr('href'), success: function () {
                $(document.body).trigger('wc_fragment_refresh');
...
!function (e) {
    ...
    e.flexslider = function (a, n) {
        ...
        var s, r = i.vars.namespace, o = window.navigator && window.navigator.msPointerEnabled && window.MSGesture,
            ...
            c = "click touchend MSPointerUp", d = "", u = "vertical" === i.vars.direction, v = i.vars.reverse,
        ...
        e.data(a, "flexslider", i), g = {
            init: function () {
                ...
                var s, r, l, c, d, f, g, h, S, x = !1, y = 0, w = 0, b = 0;
...
var metaslider_1177 = function ($) {
    $('#metaslider_1177').addClass('flexslider');
...
(function () {
    ...
    function b(a) {
        return function (b, c, d) {
            c = u(c, d);
            for (var e = z(b), f = a > 0 ? 0 : e - 1; f >= 0 && f < e; f += a) if (c(b[f], f, b)) return f;
            return -1
        }
    }
    ...
    s.each = s.forEach = function (a, b, c) {
        b = t(b, c);
        var d, e;
        if (A(a)) for (d = 0, e = a.length; d < e; d++) b(a[d], d, a); else {
            var f = s.keys(a);
    ...
    s.keys = function (a) {
        ...
        b = u(b, c);
        for (var d, e = s.keys(a), f = 0, g = e.length; f < g; f++) if (d = e[f], b(a[d], d, a)) return d
...
!function (C, d, e, n) {
    ...
    t.prototype.onReset = function (t) {
        ...
        var a = t.data.variationForm, i = a.getChosenAttributes(), e = i.data;
        if (i.count === i.chosenCount) if (a.useAjax) a.xhr && a.xhr.abort(), a.$form.block({
            message: null,
        ...
        var i = t.data.variationForm, e = i.$product.find(".product_meta").find(".sku"),
            ...
            n = i.$singleVariationWrap.find(".quantity"), s = !0, c = !1, _ = "";
        ...
        var a = t.data.variationForm;
        a.$form.find('input[name="variation_id"], input.variation_id').val("").change(), a.$form.find(".wc-no-matching-variations").remove(), a.useAjax ? a.$form.trigger("check_variations") : (a.$form.trigger("woocommerce_variation_select_change"), a.$form.trigger("check_variations"), C(this).blur()), a.$form.trigger("woocommerce_variation_has_changed")
    }, t.prototype.addSlashes = function (t) {
        return t = (t = t.replace(/'/g, "\\'")).replace(/"/g, '\\"')
    }, t.prototype.onUpdateAttributes = function (t) {
        var y = t.data.variationForm, F = y.getChosenAttributes().data;
        y.useAjax || (y.$attributeFields.each(function (t, a) {
            var i, e = C(a), r = e.data("attribute_name") || e.attr("name"), o = C(a).data("show_option_none"),
                n = ":gt(0)", s = C("<select/>"), c = e.val() || "", _ = !0;
            ...
            var m = C.extend(!0, {}, F);
            m[r] = "";
            var v = y.findMatchingVariations(y.variationData, m);
            for (var l in v) if ("undefined" != typeof v[l]) {
                var g = v[l].attributes;
                for (var f in g) if (g.hasOwnProperty(f)) {
                    var u = g[f], h = "";
                    if (f === r) if (v[l].variation_is_active && (h = "enabled"), u) {
                        u = C("<div/>").html(u).text();
                        var p = s.find("option");
                        if (p.length) for (var w = 0, b = p.length; w < b; w++) {
                            var $ = C(p[w]);
                            if (u === $.val()) {
                                $.addClass("attached " + h);
                                break
        ...
        return this.$attributeFields.each(function () {
            var t = C(this).data("attribute_name") || C(this).attr("name"), a = C(this).val() || "";
        ...
        var a = C(this), i = a.closest(".product").find(".images"), e = !1, r = t && t.image_id ? t.image_id : "";
        ...
        var a = this, i = a.closest(".product"), e = i.find(".images"), r = i.find(".flex-control-nav"),
            ...
            s = n.find(".wp-post-image"), c = n.find("a").eq(0);
        ...
        var t = this.closest(".product"), a = t.find(".images"), i = t.find(".flex-control-nav").find("li:eq(0) img"),
            ...
            r = e.find(".wp-post-image"), o = e.find("a").eq(0);
    ...
    var m = function (t) {
        var a = e.getElementById("tmpl-" + t).textContent, i = !1;
